...
class PrintTreeTests extends FlatSpec {
  ...
  def setup(): CompilationManager[ulNoActionsLexer,ulNoActionsParser,TreePrinter,TreePrinter,TreePrinter] = {
    return (new CompilationManager[ulNoActionsLexer,ulNoActionsParser,TreePrinter,TreePrinter,TreePrinter]
